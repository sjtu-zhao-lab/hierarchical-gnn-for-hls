...
parser.add_argument('--val_ratio', type=float, default=0) # ratio of database for validation set
...
multi_target = ['latency','lut', 'ff', 'dsp', 'II']
target = 'dsp'
...
parser.add_argument('--node_attention', type=bool, default=False)
